...
<body>
	...
	<form:form modelAttribute="formsModel" action="REPLACE_BY_SCRIPT"
		id="form" method="POST">
		<div id="wrapper">
									...
									<div class="col-lg-6">
										<form role="form">
											...
											<div class="form-group">
												...
												<div class="checkbox">
													<label> <input 
															type="checkbox" value="" />Checkbox 3
													</label>
												</div>
											</div>
											<div class="form-group">
											...
											<button type="submit" class="btn btn-default" formaction="input">Submit
												Button</button>

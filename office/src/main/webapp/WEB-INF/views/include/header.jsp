		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href='<c:url value="/login/init"/>' class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>GOA</b></span> <!-- logo for regular state and mobile devices -->
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="<c:url value='/static/img/user3-128x128.jpg'/>"
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="<c:url value='/static/img/user3-128x128.jpg'/>" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="<c:url value='/static/img/user3-128x128.jpg'/>" class="img-circle"
									alt="User Image">
